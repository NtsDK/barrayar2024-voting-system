...
const councilSessions = [
  {
    id: "sessionTest",
    title: "Пробное заседание",
    dateTime: "22 августа 19:00",
    status: "countessVoting",
  },
  {
    id: "session_friday_morning",
    title: "Заседание Пт утро",
    dateTime: "23 августа 11:00",
    status: "planned",
  },
  {
    id: "session_friday_evening",
    title: "Заседание Пт вечер",
    dateTime: "23 августа 19:00",
    status: "planned",
  },
  {
    id: "session_saturday_morning",
    title: "Заседание Сб утро",
    dateTime: "24 августа 11:00",
    status: "planned",
  },
  {
    id: "session_saturday_evening",
    title: "Заседание Сб вечер",
    dateTime: "24 августа 19:00",
    status: "planned",
  },
];
...
const sessionQuestions = [
  {
    ...
    type: "player",
    questionText: "1. Какого цвета трава?",
    answer1: "Красная",
  ...
  },
  {
    ...
    session_id: "sessionTest",
    type: "player",
    questionText: "3. Должен ли любимый конь императора стать графом?",
  ...
  // },
  {
    id: "question-fri_mon_gen_staff",
    session_id: "session_friday_morning",
    type: "player",
    questionText: "1. Вопрос генштаба",
    answer1: "",
    answer1_advocate_id: null,
    answer2: "",
    answer2_advocate_id: null,
  ...
  {
    id: "question-fast_penta",
    session_id: "session_friday_morning",
    type: "player",
    questionText: "2. Принять закон о медицинском препарате для допросов супер-пентотале?",
    answer1: "Да, принять",
    answer1_advocate_id: null,
    answer2: "Нет, не принять, отправить на доработку.",
    answer2_advocate_id: null,
    status: "raised",
    voteLog: "{}",
  },
  {
    id: "question-fri_evn_gen_staff",
    session_id: "session_friday_evening",
    type: "player",
    questionText: "1. Вопрос генштаба",
    answer1: "",
    answer1_advocate_id: null,
  ...
  {
    id: "question-discorde_valley",
    session_id: "session_friday_evening",
    type: "player",
    questionText: "2. Считать долину Дискорде частью округа Бранбор или частью округа Новак?",
    answer1: "Часть округа Бранбор (Форховиц)",
    answer1_advocate_id: null,
    answer2: "Часть округа Новак (Форпински)",
    answer2_advocate_id: null,
    status: "raised",
    voteLog: "{}",
  },
  {
    id: "question-sat_mon_gen_staff",
    session_id: "session_saturday_morning",
    type: "player",
    questionText: "1. Вопрос генштаба",
    answer1: "",
    answer1_advocate_id: null,
  ...
  {
    id: "question-forlakial_count",
    session_id: "session_friday_evening",
    type: "player",
    questionText:
      "2. Утвердить смену наследника графа Форлакиала. Прежний лорд Форлакиал - племянник графа Кермит, новый лорд Форлакиал - признанный сын-бастард графа Форлакиала Малькольм Форлакиал",
    answer1: "Да",
    answer1_advocate_id: null,
    answer2: "Нет",
    answer2_advocate_id: null,
  ...
  {
    id: "question-sat_evn_gen_staff",
    session_id: "session_saturday_evening",
    type: "player",
    questionText: "1. Вопрос генштаба",
    answer1: "",
    answer1_advocate_id: null,
