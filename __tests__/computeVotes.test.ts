...
// import computeVotes from "@/app/lib/computeVotes";
// import {
//   CountVoteStatus,
//   CountsVoteLog,
//   Vote,
...
//     expect(() => computeVotes(makeCountsVoteLog(), [])).toThrow(
//       "Есть незаполненные графы"
//     );
//   });
...
//       []
//     );
//     expect(res).toBe<CountVoteStatus>("answer1");
//   });
...
//       []
//     );
//     expect(res).toBe<CountVoteStatus>("answer2");
//   });
...
//       []
//     );
//     expect(res).toBe<CountVoteStatus>("draw");
//   });
